...
const columns = computed(() => {
  const Columns = [
      { field: 'WorkOrderRegisterCode', header: t('ProductionReceipt.ReceiptNo'), sortable: true },
        { field: 'WorkOrderRegisterName', header: t('WorkOrderRegister.Date'), type: 'slot', sortable: true },
        { field: 'departmentName', header: t('downtime.WorkOrder'), type: 'slot', sortable: true },
        { field: 'departmentName', header: t('BOM.FinalProduct'), type: 'slot', sortable: true },
        ...
        { field: 'departmentName', header: t('downtime.DowntimeType'), type: 'slot', sortable: true },
        { field: 'departmentName', header: t('downtime.downtime'), type: 'slot', sortable: true },
        { field: 'departmentName', header: t('machines.SetupTime'), type: 'slot', sortable: true },
...
<template>
 ...
 <ScreenHeader title="production" subtitle="reports.title" actionName="ProductionReceipt.ProductionReceiptReport" />
    <card class="bg-white rounded-[10px] w-full overflow-x-auto">
      <!-- PageHeader component -->
      <template #title>
         <PageHeader
          title="ProductionReceipt.ReportTitle"
          subtitle="ProductionReceipt.ReportDescription"
          :showExport="true"
          :showSearch="false"
          :onExport="onExport"
        />
