...
const columns = computed(() => {
  const Columns = [
     { field: 'code', header: t('BOM.code'), sortable: true },
        ...
        { field: 'BOM', header: t('BOM.FinalProduct'), type: 'slot', sortable: true },
        { field: 'BOM', header: t('BOM.Version'), sortable: true },
        { field: 'department', header: t('itemList.itemCode'), type: 'slot', sortable: true },
        { field: 'department', header: t('itemList.itemName'), type: 'slot', sortable: true },
       { field: 'department', header: t('BOM.MatQty'), type: 'date', sortable: true },
        { field: 'department', header: t('workOrder.UOM'), type: 'slot', sortable: true },
       { field: 'department', header: t('BOM.Seq'), type: 'date', sortable: true },
       { field: 'department', header: t('BOM.Process'), type: 'date', sortable: true },
       { field: 'department', header: t('BOM.Machine'), type: 'date', sortable: true },
       { field: 'department', header: t('BOM.RunTime'), type: 'date', sortable: true },
...
<template>
 ...
 <ScreenHeader title="production" subtitle="reports.title" actionName="BOM.BOM" />
    <card class="bg-white rounded-[10px] w-full overflow-x-auto">
      <!-- PageHeader component -->
      <template #title>
         <PageHeader
          title="BOM.ReportTitle"
          subtitle="BOM.ReportDescription"
          :showExport="true"
          :showSearch="false"
          :onExport="onExport"
        />
