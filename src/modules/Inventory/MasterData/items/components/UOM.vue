    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-24">
      ...
      <div class="md:col-span-3 flex flex-col items-center gap-3 mt-5">
        <div
          ...
          :class="{
            'rule-body-ar': $i18n.locale === 'ar',
            'rule-body': $i18n.locale !== 'ar',
          }"
        >
          <div class="">
            <p class="font-bold">{{ $t("items.rule") }} {{ index + 1 }}</p>
            <div
              class="w-full grid grid-cols-1 md:grid-cols-5 gap-4 mt-3 items-center"
            >
