...
// Sync visibility (زي ما هو بدون تغيير)
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        <div class="flex flex-col gap-1 w-1/2">
                            ...
                            <InputText v-model.number="qtyInput"
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <InputText v-model="expireDateInput"
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <InputText v-model="commentInput"
                ...
                <div class="flex-1 overflow-hidden rounded-lg bg-[#EFF4FF] border border-gray-100">
                    ...
                    >
                        <template #col-batch="{ data }">
                            <span class="text-xs uppercase bg-white border border-gray-200 px-2 py-1 rounded text-gray-600">
                                {{ data.batch }}
                            </span>
                        </template>
