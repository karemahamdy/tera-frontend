...
<template>
  <div class="grid grid-rows gap-2">
    ...
    <FormInput :label="t('RequestInformation.InventoryRequestNumber')" v-model="InventoryRequestNumber" :error="errors.InventoryRequestNumber"
      :placeholder="t('RequestInformation.InventoryRequestNumberPlaceholder')" :invalid="!!errors.InventoryRequestNumber" :disabled="!!id" />

    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
      <FormInput :label="t('RequestInformation.RequestedBy')" v-model="RequestedBy"
    ...
    <FormDropdown class="w-full pt-8" :label="t('RequestInformation.type')" :options="currencyOptions" optionLabel="label"
      optionValue="value" v-model="selectedtype" :error="errors.type"
      :placeholder="t('RequestInformation.typePlaceholder')" />


    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">

      <FormDropdown :label="t('RequestInformation.SourceWarehouse')" v-model="SourceWarehouse" :error="errors.SourceWarehouse"
        :placeholder="t('RequestInformation.SourceWarehousePlaceholder')" />
      <FormDropdown :label="t('RequestInformation.TargetWarehouse')" v-model="TargetWarehouse" :error="errors.TargetWarehouse"
