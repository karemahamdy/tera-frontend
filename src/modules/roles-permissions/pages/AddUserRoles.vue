...
<template>
  <div class="p-6 w-full h-full bg-gray-100">
    ...
    <div
      ...
      :class="accessScope === 'global' ? 'border-primary-400 bg-primary-25' : 'border-gray-300'"
    ...
    >
      <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col">
          <label class="font-medium text-gray-500 cursor-pointer">Global Access  /access to all branches</label>
    ...
    <div
      class="flex items-center justify-between border rounded-xl px-4 py-4 cursor-pointer hover:border-primary-300 transition"
      :class="accessScope === 'branch' ? 'border-primary-400 bg-primary-25' : 'border-gray-300'"
    ...
    >
      <div class="flex items-center gap-3">
        ...
        />
        <div class="flex flex-col">
          <label class="font-medium text-gray-800 cursor-pointer">Branch-Specific Access  /Limited to assigned branch only</label>
