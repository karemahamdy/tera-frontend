...
import { userGroupRoutes } from "@/modules/AccessControl/user-group/routes";
import { branchesRoutes } from "@/modules/AccessControl/branch-management/routes";
import { rolesPermissionsRoutes } from "@/modules/AccessControl/roles-permissions/routes";
import { auditLogRoutes } from "@/modules/AccessControl/audit-log/routes";
...
import { OperationActualsRoutes } from "@/modules/Production/Report/operation-actuals/routes";
import { DowntimeLogRoutes } from "@/modules/Production/Report/downtime-log/routes";
import { ProductionReceiptRoutes } from "@/modules/Production/Report/production-receipt/routes";
...
const routes = [
  ...authRoutes,
  {
    ...
    children: [
      ...
      ...OperationActualsRoutes,
      ...DowntimeLogRoutes,
      ...ProductionReceiptRoutes,
      {
        path: "",
        component: () => import("@/app/layouts/DefaultLayout.vue"),
        name: "Dashboard",
