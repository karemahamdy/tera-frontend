...
<template>
    <Button v-slot="slotProps" asChild>
        ...
        <button @click="handleClick" :class="[
            ...
            block ? 'w-full' : '',
            variant === 'primary' && 'bg-primary-500 hover:bg-primary-600 text-white border-none px-8',
            variant === 'danger' && 'bg-danger-500 hover:bg-danger-600 text-white border-none px-16',
